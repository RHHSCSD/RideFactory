 ...
 * @author amirb
 */
public class Automation implements Upgrade {
    //Variables
    ...
    private int price;
    //Holds value for the income made per second
    private int income;
    ...
    public void effectivenessUp(int percent) {
        ...
        if (percentEffectiveness > 0) {
            income = (int) (income * ((double)(1 + (0.01 * percentEffectiveness))));
    ...
    //Adds the income from automation to cash, accounting for the increase in effectiveness
    public void click(Cash c) {
        c.addCash(income);
    }
}
